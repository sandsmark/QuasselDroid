...
public class CoreConnection {
	...
	public void connect() throws UnknownHostException, IOException, GeneralSecurityException {	
			...
			packedFunc.add(new QVariant<Integer>(RequestType.Sync.getValue(), QVariantType.Int));
			packedFunc.add(new QVariant<String>("BufferSyncer", QVariantType.String));
			packedFunc.add(new QVariant<String>("", QVariantType.String));
			packedFunc.add(new QVariant<String>("requestPurgeBufferIds", QVariantType.String));
