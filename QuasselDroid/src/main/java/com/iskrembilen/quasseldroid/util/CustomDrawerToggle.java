...
public class CustomDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    /**
     * Allows an implementing Activity to return an {@link CustomDrawerToggle.Delegate} to use
    ...
    private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl {
        @Override
        public Drawable getThemeUpIndicator(Activity activity) {
            return CustomDrawerToggleHoneycomb.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                                              Drawable themeImage, int contentDescRes) {
            return CustomDrawerToggleHoneycomb.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return CustomDrawerToggleHoneycomb.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
